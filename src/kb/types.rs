            ...
            match self {
                CR::First => {
                    if for_tbi {
                        ...
                        format!("A{}: (a,b): r -> a: Exists r, b: Exists r^-", self.identifier())
                    }
                }
                CR::Second => {
                    if for_tbi {
