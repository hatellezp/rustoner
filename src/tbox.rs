...
// internal imports
use crate::helpers_and_utilities::{
    tbox_complete_helper_add_if_necessary_one, tbox_complete_helper_add_if_necessary_two,
    tbox_complete_helper_dump_from_mutex_temporal_to_current2,
};
use crate::rule::{
...
impl TB {
    ...
    pub fn add(&mut self, it: TBI) -> bool {
        /*
        ...
        */
        ...
        // A=>notB then B=>notA
        {
            ...
            // then dump everything in 'items' from 'items_temporal'
            {
                ...
                length = tbox_complete_helper_dump_from_mutex_temporal_to_current2(
                    &mut items,
                    &mut items_temporal,
                    length,
                    length_temporal,
